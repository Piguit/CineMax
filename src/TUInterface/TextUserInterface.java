...
public class TextUserInterface {
    ...
    private void addShow() {
        ...
        LocalDateTime date = mh.readDateAndTime("Data e ora - dd/mm/yyyy hh:mm:ss: ", true);
    ...
    private void editShow() {
        Long showId = mh.readLong("Identificativo della proiezione: ", true);
        LocalDateTime newShowDate = mh.readDateAndTime("Data e ora nuove - dd/mm/yyyy hh:mm:ss: ", true);
