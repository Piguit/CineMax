...
public class ReservationService {
    ...
    public List<Reservation> visualizeMyReservations(String username) {
    ...
    public Long addReservation(String username, Long showId, Byte ticketsNumber) {
        ...
        if (s.getShowDate().isBefore(LocalDateTime.now()))
            throw new IllegalArgumentException("Show already projected");
    ...
    public void editReservation(String username, Long reservationId, Long newShowId) {
        ...
        if (r == null)
            throw new IllegalArgumentException("Inexistent reservation");
        if (!r.getUsername().equals(username))
            throw new IllegalArgumentException("Input reservation doesn't belong to the current user");
    ...
    public List<Reservation> searchTodayReservations() {
    ...
    public List<ReservationDetails> searchReservationsInDetail(Long reservationId, String name,
                        ...
                        if (s.getId().equals(showId)) {
                            ...
                            for (Movie m : movieList)
                                if (m.getId().equals(foundShowId)) {
                                    movie = m;
                                    if (!partialTitle.equals(m.getTitle()))
                                        ok = false;
                                    else
                                        stop = true;
                                    break;
